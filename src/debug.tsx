...
function DebugApp() {
  ...
  return (
    <div className="min-h-screen bg-gruv-dark p-5 text-gruv-light font-mono">
      <h1 className="text-xl text-gruv-yellow mb-4">Lexical Code Block Debug</h1>
      ...
      <div className="bg-gruv-dark-1 p-3 rounded mb-5 text-xs">
        ...
        <ol className="list-decimal ml-5 space-y-1">
          ...
          <li>Type <code className="bg-gruv-dark-2 px-1 rounded">```</code> + space to create code block</li>
